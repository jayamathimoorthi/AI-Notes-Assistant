...
def create_chunks(text, chunk_size=7000):
    text = text or ""
...
def notes_prompt(notes, question):
    return f"""You are an AI Notes Assistant.
Answer the user's question ONLY using the uploaded notes below.
If the answer is not present in the notes, say clearly:
"I couldn't find that information in your uploaded notes."
Do not invent facts. Give a direct, easy-to-understand answer.
